...
# =============================================================================
# TICKERS (Quality large/mid caps)
# =============================================================================
TICKERS = [
    'AAPL', 'ABBV', 'ABT', 'ACN', 'ADBE', 'ADI', 'ADP', 'ADSK', 'AEP', 'AFL',
    'AIG', 'ALL', 'AMAT', 'AMD', 'AMGN', 'AMP', 'AMT', 'AMZN', 'ANET', 'AON',
    'APD', 'APH', 'AVGO', 'AXP', 'AZO', 'BA', 'BAC', 'BDX', 'BK', 'BKNG',
    'BLK', 'BMY', 'BRK-B', 'BSX', 'C', 'CAT', 'CB', 'CCI', 'CDNS', 'CE',
    'CF', 'CHTR', 'CI', 'CL', 'CMCSA', 'CME', 'CMG', 'CMI', 'CNC', 'COF',
    'COP', 'COST', 'CRM', 'CSCO', 'CSX', 'CTAS', 'CVS', 'CVX', 'D', 'DE',
    'DFS', 'DHI', 'DHR', 'DIS', 'DLR', 'DOV', 'DOW', 'DUK', 'EA', 'EBAY',
    'ECL', 'ED', 'EFX', 'EL', 'EMR', 'EOG', 'EQIX', 'ETN', 'EW', 'EXC',
    'F', 'FANG', 'FAST', 'FCX', 'FDX', 'FI', 'FICO', 'FIS', 'FISV', 'GD',
    'GE', 'GILD', 'GIS', 'GL', 'GLW', 'GM', 'GOOG', 'GOOGL', 'GPC', 'GS',
    'GWW', 'HAL', 'HCA', 'HD', 'HIG', 'HLT', 'HON', 'HPQ', 'HSY', 'HUM',
    'IBM', 'ICE', 'INTC', 'INTU', 'ISRG', 'ITW', 'JCI', 'JNJ', 'JPM', 'KDP',
    'KEY', 'KLAC', 'KMB', 'KO', 'KR', 'L', 'LEN', 'LIN', 'LLY', 'LMT',
    'LOW', 'LRCX', 'LULU', 'MA', 'MAR', 'MCD', 'MCHP', 'MCK', 'MCO', 'MDLZ',
    'MDT', 'MET', 'META', 'MMC', 'MMM', 'MO', 'MPC', 'MRK', 'MS', 'MSCI',
    'MSFT', 'MSI', 'MTB', 'MU', 'NDAQ', 'NEE', 'NFLX', 'NKE', 'NOC', 'NOW',
    'NSC', 'NTRS', 'NUE', 'NVDA', 'O', 'OKE', 'OMC', 'ORCL', 'ORLY', 'OXY',
    'PANW', 'PAYX', 'PCAR', 'PEP', 'PFE', 'PG', 'PGR', 'PH', 'PHM', 'PLD',
    'PM', 'PNC', 'PPG', 'PRU', 'PSA', 'PSX', 'PYPL', 'QCOM', 'RCL', 'REGN',
    'RF', 'RJF', 'RMD', 'ROK', 'ROP', 'ROST', 'RSG', 'RTX', 'SBUX', 'SCHW',
    'SHW', 'SLB', 'SNPS', 'SO', 'SPGI', 'SRE', 'STT', 'STZ', 'SYK', 'SYY',
    'T', 'TDG', 'TFC', 'TGT', 'TJX', 'TMO', 'TMUS', 'TRV', 'TSLA', 'TT',
    'TXN', 'TYL', 'UHS', 'UNH', 'UNP', 'UPS', 'URI', 'USB', 'V', 'VLO',
    'VMC', 'VRTX', 'VZ', 'WAB', 'WEC', 'WELL', 'WFC', 'WM', 'WMB', 'WMT',
    'WRB', 'XEL', 'XOM', 'YUM', 'ZBH', 'ZTS',
]
